    ...
    def run(self, num_timesteps=None, num_episodes=None, max_episode_timesteps=None, deterministic=False,
        ...
        with tqdm(total=num_episodes) as pbar:
            ...
            while True:
                ...
                while True:
                    # by setting the independent flag the action is not stored in buffer!!
                    #action = self.agent.act(states=state, deterministic=deterministic, independent=True)
                    ...
                    if not testing:
                        ...
                        print("Timestep:", self.current_timestep, "Reward:", reward)
